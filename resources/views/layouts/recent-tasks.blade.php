  <!-- Main Scrollable Area -->
      ...
      <div
        ...
        <div class="divide-y divide-gray-100 dark:divide-gray-800">
          ...
          <x-task-item title="Review pull requests"
            description="Review the latest frontend changes submitted by the team." badge-label="Development"
            badge-color="blue" time-label="Tomorrow">
